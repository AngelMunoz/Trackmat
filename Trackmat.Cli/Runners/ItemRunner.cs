...
namespace Trackmat.Runners
{
  public class ItemRunner
  {
    ...
    {
      IEnumerable<TrackItem> byIds = Array.Empty<TrackItem>();
      IEnumerable<PaginatedResult<TrackItem>> byNames = Array.Empty<PaginatedResult<TrackItem>>();
      using var service = new TrackItemService(ConnString);
