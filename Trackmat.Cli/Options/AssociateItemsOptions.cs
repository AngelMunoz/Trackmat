...
namespace Trackmat.Cli.Options
{
  ...
  public class AssociateItemsOptions
  {
    ...
    [Option('i', "items", Required = false, HelpText = "Items to associate with a period. Ex. \"CSV-2550 ABC-1234 DFG-7894\"")]
    ...
    public static int Run(AssociateItemsOptions opts)
    {
      ...
      return runner.AssociateItems(new AssociateItemArgs { EzName = opts.EzName, Items = opts.Items, Ids = ids });
    }
  }
